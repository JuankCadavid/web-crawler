...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-border text-text-primary hover:bg-highlight focus:ring-primary-500',
    ghost: 'text-text-primary hover:bg-highlight focus:ring-primary-500'
  };
